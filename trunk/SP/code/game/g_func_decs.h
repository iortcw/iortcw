...
extern int QDECL Com_sprintf (char *dest, int size, const char *fmt, ...) __attribute__ ((format (printf, 3, 4)));
...
extern void trap_Error ( const char *text ) __attribute__((noreturn));
extern void trap_Print ( const char * txt ) ;
